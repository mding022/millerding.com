        ...
        <div className="flex flex-col h-screen">
            ...
            <main className="flex-1 container mx-auto py-12 px-6">
                <section className="mb-12 text-center">
                    <h2 className="text-3xl font-bold mb-2">Add Image and Video</h2>
                    <p className="text-black">Upload a video and selfie to merge.</p>
                    <p className="text-black mt-2">
                        Make sure to upload a <span className="font-bold">clear and bright selfie and a non-blurry video</span> for best results
                    </p>
                    ...
                    <div className="p-6 rounded-lg shadow w-full max-w-md mx-auto">
                        <div className="grid gap-6 justify-center">
                            <div className="w-full">
                                <Label htmlFor="image1">Base Video</Label>
